...
var MovieController = (function () {
  ...
  MovieController.prototype.init = function () {
    var $this = this
    // 첫 화면 로고 추가
    this.space.innerHTML = '<div class="neflixLogo" contenteditable="true">YEFLIX</div><div class="neflixInfo">About All the Movies</div>';
    var intro = new Audio();
  ...
  MovieController.prototype.initElement = function () {
    ...
    nationLabel.innerText = 'Nationality ';
    nationSelect.innerHTML += '<option value = "전체">All</option><option value = "국내">Korea</option><option value = "해외">Others</option>';
    ...
    genreSelect.innerHTML += '<option value = "전체">All</option>';
    genreSelect.innerHTML += '<option value = "드라마">Drama</option>';
    genreSelect.innerHTML += '<option value = "공포">Horror</option>';
    genreSelect.innerHTML += '<option value = "액션">Action</option>';
    genreSelect.innerHTML += '<option value = "멜로">Romance</option>';
    genreSelect.innerHTML += '<option value = "코미디">Comedy</option>';
    genreSelect.innerHTML += '<option value = "판타지">Fantacy</option>';
    ...
    typeLabel.innerText = 'To be released';
  ...
  MovieController.prototype.printAll = function () {
    ...
    var imgArr = ['http://imgnews.naver.net/image/5095/2016/09/04/423025_237679_4753_99_20160904230509.PNG', 
      'http://imgnews.naver.net/image/5802/2020/04/27/0000006593_001_20200427111141401.gif',
    ...
    for (var i = 0; i < movieList.length; i++) {
      ...
      spanDirector.innerHTML = "Director     : " + movie.directors[0].peopleNm + '<br>';


      var spanGenres = document.createElement('span');
      spanGenres.innerHTML = "Genre        : " + movie.genreAlt + '<br>';

      var spanYear = document.createElement('span');
      spanYear.innerHTML = "Release Date: " + movie.openDt + '<br>';
