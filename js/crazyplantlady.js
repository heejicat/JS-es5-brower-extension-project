...
Crazyplantlady.prototype.initMain = function () {
    ...
    pot2Img.setAttribute('class', 'pots');
    ...
    pot3Img.setAttribute('class', 'pots');
...
Crazyplantlady.prototype.initStart = function (info) {
    ...
    waterImg.setAttribute('class', 'watercan');
    waterImg.setAttribute('src', './css/watercursor1.gif');
        ...
        plant.onmouseover = function () {
            ...
            $('.pot').on('click', function (e) {
                ...
                if ($this.width >= 100) {
                    ...
                    // if water gauge is 100 level up
                    $this.waterCount++;
                    plant.style.cursor = "auto";
            ...
            function explodeCon(x, y) {
                ...
                for (var i = 0; i < particles; i++) {
                    ...
                    var x = confetti.width()/2 + rand(60, 70) * Math.cos(2 * Math.PI * i / rand(particles - 10, particles + 10)),
                        y = confetti.height()/2-10 + rand(60, 70) * Math.sin(2 * Math.PI * i / rand(particles - 10, particles + 10));
    ...
    // water gauge decrease as time goes
    function dying() {
        var elem = document.getElementById("myBar");
