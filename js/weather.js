var WeatherController = (function () {
    ...
    WeatherController.prototype.initElement = function() {
       ...
       cardDiv.appendChild(innerSvg);
        ...
        var koreanWeather = [{city: 'Seoul', temp: '16', weather: 3, dust: 'Good', min: '8', max: '20', rainny: '80%', rainfall: '20mm'},
        {city: 'London', temp: '20', weather: 2, dust: 'Not Bad', min: '15', max: '25', rainny: '70%', rainfall: '5mm'},
        {city: 'Beijing', temp: '-2', weather: 0, dust: 'Very Bad', min: '-10', max: '3', rainny: '80%', rainfall: '30mm'},
        {city: 'Paris', temp: '18', weather: 1, dust: 'Good', min: '15', max: '22', rainny: '0%', rainfall: '0mm'},
        {city: 'L.A', temp: '25', weather: 4, dust: 'Good', min: '18', max: '28', rainny: '10%', rainfall: '0mm'}]
       ...
       function changeInfo(cityName, cityTemp, cityDust, cityMin, cityMax, cityRainny, cityRainFall, weatherCheck){
           ...
           date.innerHTML = today.toLocaleDateString();
            ...
            if(weatherCheck==1||weatherCheck==4){
                rainfallDiv.innerHTML = 'Probability: '+cityRainny;
            } else {
                rainfallDiv.innerHTML = 'Precipitation: '+cityRainFall;
            }
       }
